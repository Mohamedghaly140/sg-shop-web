...
type AdminCustomerDetailErrorProps = {
  error: Error & { digest?: string };
  unstable_retry: () => void;
};

export default function AdminCustomerDetailError({ error, unstable_retry }: AdminCustomerDetailErrorProps) {
  useEffect(() => {
    console.error(error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center h-96 gap-4 p-6 text-center">
      ...
      <div className="space-y-1">
        <p className="font-semibold">Failed to load customer</p>
